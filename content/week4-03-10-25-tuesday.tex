...
\begin{itemize}
    ...
    \item \textbf{Fraenkel (1921):} 2 Axiome \inlinemetanote{[Anmerkung: Typische Lehrbücher zählen oft nur 8 Axiome (Extensionalität, Leere Menge, Paarung, Vereinigung, Potenzmenge, Aussonderung, Ersetzung, Unendlichkeit, Fundierung), da Aussonderung oft als Spezialfall der Ersetzung gilt oder die leere Menge weggelassen wird.]}
\end{itemize}
