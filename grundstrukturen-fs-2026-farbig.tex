...
\tcbset{
  every box/.append style={
    before skip=10pt plus 3pt minus 2pt, 
    after skip=10pt plus 3pt minus 2pt,  
    underlay first={
...
\setlength{\customparskip}{4pt plus 2pt minus 1pt}
...
\newenvironment{short-proof}[1][Beweis]{
    \par\if@nobreak\vspace{-1ex}\else\addvspace{1.5ex plus 0.3ex minus 0.2ex}\fi
    \insideprooftrue 
